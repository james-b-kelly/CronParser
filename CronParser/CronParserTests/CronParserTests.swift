...
class CronParserTests: XCTestCase {
    ...
    var data: [TestDataItem] = [
        ...
        TestDataItem(config: "sdfsd 0 /bin/case13", time: "0:02", desiredOutput: "Invalid time in input line - `sdfsd 0 /bin/case13`"),
        TestDataItem(config: "12 x /bin/case13", time: "0:02", desiredOutput: "Invalid time in input line - `12 x /bin/case13`")
